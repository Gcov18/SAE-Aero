        ...
        if stiffnesses:
            for i in range(len(lift["Ls"])):
                line = "{}, {}, {}, {}, {}, {}\n".format(
                    ...
                    diagram["Shear"]["Vs"][i],
                    diagram["Torque"]["Ts"][i],
                    diagram["BendStiffness"]["Is"][i],
                    diagram["TorStiffness"]["Js"][i],
                )
                outfile.write(line)
        else:
            for i in range(len(lift["Ls"])):
                line = "{}, {}, {}, {}\n".format(
                    lift["Ls"][i], diagram["Moment"]["Ms"][i], diagram["Shear"]["Vs"][i], diagram["Torque"]["Ts"][i]
                )
                outfile.write(line)
    else:
...
def calculateCases():
    case2 = LD(
        ...
        [
            (0.675, 6.06189, 0.0),
            (0.55, 5.723848, 0.7),
        ],  # (cl, clalpha, x) assumed to be linear between two points and constant if otherwise
    ...
    case2.fuelLevel = 0.7
    case2.genDiagrams(118.4, 1.225, filename="case2b.tex")
    case2.fuelLevel = 0.7
    case2.genDiagrams(118.4, 1.225, filename="case2c.tex")
    ...
    case3.fuelLevel = 0.7
    case3.genDiagrams(118.38, 1.225, filename="case3b.tex")
    case3.fuelLevel = 1.0
    case3.genDiagrams(118.38, 1.225, filename="case3c.tex")
    ...
    case4.fuelLevel = 0.7
    case4.genDiagrams(147.98, 1.225, filename="case4b.tex")
    case4.fuelLevel = 1.0
    case4.genDiagrams(147.98, 1.225, filename="case4c.tex")
...
def main():
    ...
    case1.fuelLevel = 0.7
    case1.genDiagrams(148, 1.225, filename="case1b.tex")
    case1.fuelLevel = 1.0
    case1.genDiagrams(148, 1.225, filename="case1c.tex")
