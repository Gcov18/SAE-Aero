...
#To calculate lift force with variations (n, V)
...
def titik(n,V):
    ...
    t = 0.255 # distance thrust to CG assumption(m)
    ...
    K = W*0.0 #W sin theta assumption
    ##########
    ...
    print ('For n = ',n,' and V = ', V,' the obtained Lw = ' ,liftwing, ' N and Lt = ', lifttail," N" )
