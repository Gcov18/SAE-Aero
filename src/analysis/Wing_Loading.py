def calculate_wing_loading(
    total_weight_lbs, inner_wing_weight_lbs, outer_wing_weight_lbs, inner_wing_area_ft2, outer_wing_area_ft2
):
    """
...
if __name__ == "__main__":
    ...
    wing_loading = calculate_wing_loading(
        total_weight_lbs, inner_wing_weight_lbs, outer_wing_weight_lbs, inner_wing_area_ft2, outer_wing_area_ft2
    )
    print(
        f"Inner Wing Loading: {wing_loading['inner_wing_loading_lbs_per_in2']:.6f} lbs/in², "
        f"{wing_loading['inner_wing_loading_lbs_per_ft2']:.6f} lbs/ft²"
    )
    print(
        f"Outer Wing Loading: {wing_loading['outer_wing_loading_lbs_per_in2']:.6f} lbs/in², "
        f"{wing_loading['outer_wing_loading_lbs_per_ft2']:.6f} lbs/ft²"
    )
    print(
        f"Total Wing Loading: {wing_loading['total_wing_loading_lbs_per_in2']:.6f} lbs/in², "
        f"{wing_loading['total_wing_loading_lbs_per_ft2']:.6f} lbs/ft²"
    )
